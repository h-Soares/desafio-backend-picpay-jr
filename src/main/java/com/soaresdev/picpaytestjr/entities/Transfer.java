...
public class Transfer {
    ...
    @Column(nullable = false, insertable = false, updatable = false, columnDefinition = "UUID DEFAULT gen_random_uuid()")
    private UUID uuid;
    ...
    public Transfer(User payee, User payer, Instant createdAt, BigDecimal value) {
        this.payee = payee;
        this.payer = payer;
